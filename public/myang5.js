    ...
    angular.module('tubeShow', [])
        .controller('TubeController', function ($scope) {
            ...
            */
            ...
            $scope.showCoord = function (evt) {
                //alert(evt.clientX + "," + evt.clientY);
                alert("XX");
                //alert(evt.x + "," + evt.y + ";page(" + evt.pageX + "," + evt.pageY + ")");
            }
            $scope.getCoords = function() {
                if ($scope.role === "admin") {
                    $scope.stage.click(showCoord);
                }
            };
        })
        /*
